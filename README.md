...
- **Trello Board**: The team listed out various user stories for the e-learning platform on the [Trello board](https://trello.com/b/dUDCGMn6/project-3). User stories are categorized as MVP and Icebox items. As progress was made, the stories were moved to their appropriate categories (WIP/completed).
...
- **Wireframe**: Based on the user stories, the team created a [Figma wireframe](https://www.figma.com/file/6gmkSZuAMDI25RBv8hmiaE/Project-3---E-Learning-Platform-for-Financial-Literacy?type=whiteboard&node-id=0-1&t=5eElqKAEfjk6i8ll-0) to conceptualize the website's design. While the wireframe served as an initial guide, several modifications were made during development.
...
- **ERD**: The team also drafted an [Entity Relationship Diagram](https://lucid.app/lucidchart/09dc7bdd-520f-41d8-9312-5ef9105101a9/edit?invitationId=inv_15befe1e-5c87-4bfa-aa0c-c912bd6210fc&referringApp=slack&page=0_0#)) for the various models planned from the start.
...
Experience the world of financial literacy e-learning at FinCademy [here](https://fincademy.onrender.com/).
...
1. **Arrive at the landing page of FinCademy.**  
   ![Screenshot 2023-10-13 at 1 55 27 AM](https://github.com/tre3god/FinCademy/assets/124702698/2d9a5c26-6097-4e08-9fca-2b37d277174b)
...
4. **When exploring the list of available courses, you can sort by highest rating, alphabetical order, or the number of results on a page.**  
   ![Screenshot 2023-10-13 at 2 11 19 AM](https://github.com/tre3god/FinCademy/assets/124702698/5a460c8d-536a-49ef-9ee3-0d63d88e4868)
...
6. **In the course information page, learn more through the description or read what other learners have said. Once you're ready, click "Enroll" to enroll. Simple!**  
   ![Screenshot 2023-10-13 at 2 07 45 AM](https://github.com/tre3god/FinCademy/assets/124702698/c4983b69-9c38-4cde-8623-49ca66d945a8)

7. **Once enrolled, you'll be redirected to your profile and dashboard. Click the course title to begin or unenroll if needed.**  
   ![Screenshot 2023-10-13 at 1 59 16 AM](https://github.com/tre3god/FinCademy/assets/124702698/ea7d7e70-3cd4-4849-ba4c-958ad44e440d)

8. **The course content page has your course materials. Pro tip: Read carefully before attempting the quiz at the end.**  
   ![Screenshot 2023-10-13 at 1 59 16 AM](https://github.com/tre3god/FinCademy/assets/124702698/df7f0081-d9ba-41ca-9687-71f4203483be)
...
10. **Your dashboard will show an option to leave a review once a quiz is completed. Share your thoughts!**  
    ![Screenshot 2023-10-13 at 2 22 46 AM](https://github.com/tre3god/FinCademy/assets/124702698/4e80951b-7cd2-4bfd-acb5-1db9f2502f72)
...
12. **If courses aren't to your liking or quizzes are too simple, create your own! Click "Courses" on the nav bar then "Create a Course."**  
    ![Screenshot 2023-10-13 at 2 26 50 AM](https://github.com/tre3god/FinCademy/assets/124702698/e525ba06-aea6-40c1-9477-70d529f3519f)
